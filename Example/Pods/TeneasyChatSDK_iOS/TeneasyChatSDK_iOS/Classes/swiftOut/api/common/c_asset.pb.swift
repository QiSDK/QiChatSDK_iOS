...
public enum CommonAssetUploadState: SwiftProtobuf.Enum, Swift.CaseIterable {
...
/// 文件类型类型 0 ～ 4
public enum CommonAssetKind: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case none // = 0
...
/// 资源类型 0 ～ 7
public enum CommonAssetType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unknown // = 0
...
/// 资源用途 0 ～ 15
public enum CommonAssetContext: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unknown // = 0
...
public struct CommonAsset: Sendable {

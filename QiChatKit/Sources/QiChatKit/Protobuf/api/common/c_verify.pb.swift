...
public enum CommonValidatorType: SwiftProtobuf.Enum, Swift.CaseIterable {
...
public enum CommonVerifyFor: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unknown // = 0
...
public struct CommonVerify: Sendable {
  ...
  public enum OneOf_Way: Equatable, Sendable {
...
/// 短信验证
public struct CommonVerifyBySMS: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// 密码验证
public struct CommonVerifyByPassword: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// captcha验证
public struct CommonVerifyByCaptcha: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

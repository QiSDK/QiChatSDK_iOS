...
public enum CommonChatState: SwiftProtobuf.Enum, Swift.CaseIterable {
...
/// 消息类型
public enum CommonMessageFormat: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
/// 消息拥有者角色
public enum CommonMessageRole: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
/// 消息来源类型
public enum CommonMsgSourceType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case mstDefault // = 0
  ...
  /// 一键群发消息
  case mstMassTransfer // = 7

  /// ai 消息
  case mstAi // = 8

  /// ai 转人工提示
  case mstAiTransfer // = 9

  /// ai 衔接语
  case mstAiLinkWord // = 10
  ...
  public init?(rawValue: Int) {
    ...
    case 7: self = .mstMassTransfer
    case 8: self = .mstAi
    case 9: self = .mstAiTransfer
    case 10: self = .mstAiLinkWord
    case 11: self = .mstAiBegin
  ...
  public var rawValue: Int {
    ...
    case .mstMassTransfer: return 7
    case .mstAi: return 8
    case .mstAiTransfer: return 9
    case .mstAiLinkWord: return 10
    case .mstAiBegin: return 11
...
public enum CommonMessageOperate: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
/// 文本消息内容
public struct CommonMessageContent: Sendable {
...
/// 图片
public struct CommonMessageImage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// 音频
public struct CommonMessageAudio: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// 视频
public struct CommonMessageVideo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// 地理位置
public struct CommonMessageGeo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// 文件
public struct CommonMessageFile: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CommonMessageUnion: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CommonMessageAutoReplyQA: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// 自动回复消息
public struct CommonMessageAutoReply: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CommonMessageKey: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CommonMessageAutoReplyFlag: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CommonMessageWorkerChanged: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CommonMessage: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CommonWithAutoReply: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CommonWorkerTransfer: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// 请求拉入黑名单
public struct CommonBlackListApply: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// 确认拉入黑名单
public struct CommonBlackListConfirm: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// 客服发送文件记录列表
public struct CommonWorkerFileLog: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// 打卡人ID
  public var workerCheckID: Int32 {
    get {return _storage._workerCheckID}
    set {_uniqueStorage()._workerCheckID = newValue}
  }

  /// 打卡人name
  public var workerCheckName: String {
    get {return _storage._workerCheckName}
    set {_uniqueStorage()._workerCheckName = newValue}
  }
  ...
  /// 客服 info
  public var worker: Api_Common_WorkerBaseInfo {
    get {return _storage._worker ?? Api_Common_WorkerBaseInfo()}
    set {_uniqueStorage()._worker = newValue}
  }
...
extension CommonMsgSourceType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .same(proto: "MST_MASS_TRANSFER"),
    8: .same(proto: "MST_AI"),
    9: .same(proto: "MST_AI_TRANSFER"),
    10: .same(proto: "MST_AI_LINK_WORD"),
    11: .same(proto: "MST_AI_BEGIN"),
...
extension CommonWorkerFileLog: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerFileLog"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "tenant_id"),
    3: .standard(proto: "worker_id"),
    4: .standard(proto: "worker_check_id"),
    5: .standard(proto: "worker_check_name"),
    6: .standard(proto: "chat_id"),
    7: .standard(proto: "file_name"),
    8: .standard(proto: "file_url"),
    9: .standard(proto: "file_size"),
    10: .same(proto: "detail"),
    11: .standard(proto: "msg_id"),
    12: .standard(proto: "payload_id"),
    13: .standard(proto: "create_at"),
    24: .same(proto: "worker"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    init(copying source: _StorageClass) {
      ...
      _workerCheckID = source._workerCheckID
      _workerCheckName = source._workerCheckName
      _chatID = source._chatID
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularInt32Field(value: &_storage._tenantID) }()
        case 3: try { try decoder.decodeSingularInt32Field(value: &_storage._workerID) }()
        case 4: try { try decoder.decodeSingularInt32Field(value: &_storage._workerCheckID) }()
        case 5: try { try decoder.decodeSingularStringField(value: &_storage._workerCheckName) }()
        ...
        case 9: try { try decoder.decodeSingularInt32Field(value: &_storage._fileSize) }()
        case 10: try { try decoder.decodeSingularStringField(value: &_storage._detail) }()
        case 11: try { try decoder.decodeSingularInt64Field(value: &_storage._msgID) }()
        case 12: try { try decoder.decodeSingularInt64Field(value: &_storage._payloadID) }()
        case 13: try { try decoder.decodeSingularMessageField(value: &_storage._createAt) }()
        case 24: try { try decoder.decodeSingularMessageField(value: &_storage._worker) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._tenantID != 0 {
        try visitor.visitSingularInt32Field(value: _storage._tenantID, fieldNumber: 2)
      }
      if _storage._workerID != 0 {
        try visitor.visitSingularInt32Field(value: _storage._workerID, fieldNumber: 3)
      }
      if _storage._workerCheckID != 0 {
        try visitor.visitSingularInt32Field(value: _storage._workerCheckID, fieldNumber: 4)
      }
      if !_storage._workerCheckName.isEmpty {
        try visitor.visitSingularStringField(value: _storage._workerCheckName, fieldNumber: 5)
      }
      if _storage._chatID != 0 {
      ...
      if _storage._fileSize != 0 {
        try visitor.visitSingularInt32Field(value: _storage._fileSize, fieldNumber: 9)
      }
      if !_storage._detail.isEmpty {
        try visitor.visitSingularStringField(value: _storage._detail, fieldNumber: 10)
      }
      if _storage._msgID != 0 {
        try visitor.visitSingularInt64Field(value: _storage._msgID, fieldNumber: 11)
      }
      if _storage._payloadID != 0 {
        try visitor.visitSingularInt64Field(value: _storage._payloadID, fieldNumber: 12)
      }
  ...
  public static func ==(lhs: CommonWorkerFileLog, rhs: CommonWorkerFileLog) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._workerCheckID != rhs_storage._workerCheckID {return false}
        if _storage._workerCheckName != rhs_storage._workerCheckName {return false}
        if _storage._chatID != rhs_storage._chatID {return false}

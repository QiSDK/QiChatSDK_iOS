...
public enum Api_Common_CodeType: SwiftProtobuf.Enum {
...
extension Api_Common_CodeType: CaseIterable {
...
public enum Api_Common_Platform: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case `default` // = 0
...
extension Api_Common_Platform: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
/// 接口错误结构
public struct Api_Common_ErrorReport {
...
/// 错误上传参数
public struct Api_Common_ErrorReportUpload {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Api_Common_CodeType: @unchecked Sendable {}
extension Api_Common_Platform: @unchecked Sendable {}
extension Api_Common_ErrorReport: @unchecked Sendable {}
extension Api_Common_ErrorReportUpload: @unchecked Sendable {}

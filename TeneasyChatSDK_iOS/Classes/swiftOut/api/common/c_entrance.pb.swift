...
public enum Api_Common_OperationsType: SwiftProtobuf.Enum, Swift.CaseIterable {
...
public enum Api_Common_ClientType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unknown // = 0
  case workerBegin // = 1
  case workerPc // = 2
  ...
  /// web端ANDROID
  case userWebAndroid // = 111

  /// web端windows
  case userWebWindows // = 106

  /// web端HARMONYOS
  case userWebHarmonyos // = 112
  ...
  public init?(rawValue: Int) {
    ...
    case 111: self = .userWebAndroid
    case 112: self = .userWebHarmonyos
    case 113: self = .userAppHarmonyos
    case 114: self = .userHarmonyos
  ...
  public var rawValue: Int {
    ...
    case .userWebAndroid: return 111
    case .userWebHarmonyos: return 112
    case .userAppHarmonyos: return 113
    case .userHarmonyos: return 114
...
public enum Api_Common_VersionType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Api_Common_VersionType] = [
    .pre,
    .official,
  ]
...
public struct Api_Common_Entrance: @unchecked Sendable {
...
public struct Api_Common_Consult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Api_Common_ClientType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    111: .same(proto: "CLIENT_TYPE_USER_WEB_ANDROID"),
    112: .same(proto: "CLIENT_TYPE_USER_WEB_HARMONYOS"),
    113: .same(proto: "CLIENT_TYPE_USER_APP_HARMONYOS"),
    114: .same(proto: "CLIENT_TYPE_USER_HARMONYOS"),
    200: .same(proto: "CLIENT_TYPE_USER_END"),
  ]
}

extension Api_Common_VersionType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "Pre"),

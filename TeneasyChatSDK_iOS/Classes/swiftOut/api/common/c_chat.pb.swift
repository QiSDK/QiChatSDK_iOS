...
public struct CommonChatDetail: @unchecked Sendable {
...
public struct CommonChatItem: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// 首条未读消息
  public var firstUnreadMsg: CommonMessage {
    get {return _firstUnreadMsg ?? CommonMessage()}
    set {_firstUnreadMsg = newValue}
  }
  /// Returns true if `firstUnreadMsg` has been explicitly set.
  public var hasFirstUnreadMsg: Bool {return self._firstUnreadMsg != nil}
  /// Clears the value of `firstUnreadMsg`. Subsequent reads from it will return its default value.
  public mutating func clearFirstUnreadMsg() {self._firstUnreadMsg = nil}
  ...
  fileprivate var _firstUnreadMsg: CommonMessage? = nil
}
...
extension CommonChatItem: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    12: .standard(proto: "first_unread_msg"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 12: try { try decoder.decodeSingularMessageField(value: &self._firstUnreadMsg) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._firstUnreadMsg {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 12)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: CommonChatItem, rhs: CommonChatItem) -> Bool {
    ...
    if lhs._firstUnreadMsg != rhs._firstUnreadMsg {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

...
/// 错误上传参数
public struct Api_Core_ErrorReportUploadRequest: Sendable {
...
/// 错误列表参数
public struct Api_Core_ErrorReportListRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// 错误列表参数
public struct Api_Core_ErrorReportListResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

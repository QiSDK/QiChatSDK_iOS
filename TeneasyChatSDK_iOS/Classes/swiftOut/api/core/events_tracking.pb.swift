...
public enum Api_Core_ClickEvents: SwiftProtobuf.Enum {
  ...
  /// 二级菜单 - 申请一键解绑
  case statusUnbindApply // = 103

  /// 二级菜单 - 一键解绑
  case statusUnbind // = 104

  /// 二级菜单 - 确认一键解绑
  case statusUnbindConfirm // = 105

  /// 二级菜单 - 取消一键解绑
  case statusUnbindCancel // = 106

  /// 二级菜单 - 搜索
  case search // = 107

  /// 二级菜单 - 会话列表
  case sessionList // = 108
  ...
  public init?(rawValue: Int) {
    ...
    case 103: self = .statusUnbindApply
    case 104: self = .statusUnbind
    case 105: self = .statusUnbindConfirm
    case 106: self = .statusUnbindCancel
    case 107: self = .search
    case 108: self = .sessionList
  ...
  public var rawValue: Int {
    ...
    case .statusUnbindApply: return 103
    case .statusUnbind: return 104
    case .statusUnbindConfirm: return 105
    case .statusUnbindCancel: return 106
    case .search: return 107
    case .sessionList: return 108
...
public enum Api_Core_EventCategory: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Api_Core_EventCategory: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct Api_Core_EventTracking {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Api_Core_EventTracking.OneOf_Event, rhs: Api_Core_EventTracking.OneOf_Event) -> Bool {
...
public struct Api_Core_EventTrackingRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Api_Core_TimeRange {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Api_Core_EventTrackingDetailRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Api_Core_EventTrackingDetailResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public struct EventTrackingDetailItem {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct Api_Core_EventTrackingListRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Api_Core_EventTrackingListResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public struct EventTrackingItem {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct Api_Core_EventTrackingDailyStatsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var sortBy: Api_Core_EventTrackingDailyStatsRequest.SortBy {
    get {return _sortBy ?? .none}
  ...
  public enum SortBy: SwiftProtobuf.Enum {
    public typealias RawValue = Int
    case none // = 0
    case lastAlarmTriggerTime // = 1
    case totalDuration // = 2
    case alarmDuration // = 3
    case avgRespTime // = 4
    case click // = 5
    case scroll // = 6
    case send // = 7
    ...
    public init?(rawValue: Int) {
      switch rawValue {
      case 0: self = .none
      case 1: self = .lastAlarmTriggerTime
      case 2: self = .totalDuration
      case 3: self = .alarmDuration
      case 4: self = .avgRespTime
      case 5: self = .click
      case 6: self = .scroll
      case 7: self = .send
      case 8: self = .triggerTime
      default: self = .UNRECOGNIZED(rawValue)
      }
    }
    ...
    public var rawValue: Int {
      switch self {
      case .none: return 0
      case .lastAlarmTriggerTime: return 1
      case .totalDuration: return 2
      case .alarmDuration: return 3
      case .avgRespTime: return 4
      case .click: return 5
      case .scroll: return 6
      case .send: return 7
      case .triggerTime: return 8
      case .UNRECOGNIZED(let i): return i
      }
    }
  ...
  fileprivate var _timeRange: Api_Core_TimeRange? = nil
  fileprivate var _sortBy: Api_Core_EventTrackingDailyStatsRequest.SortBy? = nil
}

#if swift(>=4.2)

extension Api_Core_EventTrackingDailyStatsRequest.SortBy: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Api_Core_EventTrackingDailyStatsRequest.SortBy] = [
    .none,
    .lastAlarmTriggerTime,
    .totalDuration,
    .alarmDuration,
    .avgRespTime,
    .click,
...
public struct Api_Core_EventTrackingDailyStatsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public struct EventTrackingDailyStatsItem {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
public struct Api_Core_SetMonitorAllRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var isMonitor: Bool = false
...
public struct Api_Core_SetMonitorRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Api_Core_WorkerAlarmsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Api_Core_WorkerAlarmsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var list: [Api_Core_WorkerAlarmsResponse.Item] = []
  ...
  public struct Item {
    ...
    public var alarmTriggerTime: String = String()
...
extension Api_Core_EventCategory: @unchecked Sendable {}
extension Api_Core_EventTracking: @unchecked Sendable {}
extension Api_Core_EventTracking.OneOf_Event: @unchecked Sendable {}
extension Api_Core_EventTrackingRequest: @unchecked Sendable {}
extension Api_Core_TimeRange: @unchecked Sendable {}
extension Api_Core_EventTrackingDetailRequest: @unchecked Sendable {}
extension Api_Core_EventTrackingDetailResponse: @unchecked Sendable {}
extension Api_Core_EventTrackingDetailResponse.EventTrackingDetailItem: @unchecked Sendable {}
extension Api_Core_EventTrackingListRequest: @unchecked Sendable {}
extension Api_Core_EventTrackingListResponse: @unchecked Sendable {}
extension Api_Core_EventTrackingListResponse.EventTrackingItem: @unchecked Sendable {}
extension Api_Core_EventTrackingDailyStatsRequest: @unchecked Sendable {}
extension Api_Core_EventTrackingDailyStatsRequest.SortBy: @unchecked Sendable {}
extension Api_Core_EventTrackingDailyStatsResponse: @unchecked Sendable {}
extension Api_Core_EventTrackingDailyStatsResponse.EventTrackingDailyStatsItem: @unchecked Sendable {}
extension Api_Core_SetMonitorAllRequest: @unchecked Sendable {}
extension Api_Core_SetMonitorRequest: @unchecked Sendable {}
extension Api_Core_WorkerAlarmsRequest: @unchecked Sendable {}
extension Api_Core_WorkerAlarmsResponse: @unchecked Sendable {}
extension Api_Core_WorkerAlarmsResponse.Item: @unchecked Sendable {}
...
extension Api_Core_ClickEvents: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    103: .same(proto: "ClickEvents_STATUS_UNBIND_APPLY"),
    104: .same(proto: "ClickEvents_STATUS_UNBIND"),
    105: .same(proto: "ClickEvents_STATUS_UNBIND_CONFIRM"),
    106: .same(proto: "ClickEvents_STATUS_UNBIND_CANCEL"),
    107: .same(proto: "ClickEvents_SEARCH"),
    108: .same(proto: "ClickEvents_SESSION_LIST"),
...
extension Api_Core_EventTracking: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "unprocessed_3min_count"),
    4: .standard(proto: "timeout_count"),
    5: .standard(proto: "transfer_count"),
    6: .standard(proto: "is_busy"),
    7: .same(proto: "click"),
    8: .same(proto: "scroll"),
    9: .same(proto: "action"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.unprocessed3MinCount) }()
      case 4: try { try decoder.decodeSingularUInt32Field(value: &self.timeoutCount) }()
      case 5: try { try decoder.decodeSingularUInt32Field(value: &self.transferCount) }()
      case 6: try { try decoder.decodeSingularBoolField(value: &self.isBusy) }()
      case 7: try {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.unprocessed3MinCount != 0 {
      try visitor.visitSingularUInt32Field(value: self.unprocessed3MinCount, fieldNumber: 3)
    }
    if self.timeoutCount != 0 {
      try visitor.visitSingularUInt32Field(value: self.timeoutCount, fieldNumber: 4)
    }
    if self.transferCount != 0 {
      try visitor.visitSingularUInt32Field(value: self.transferCount, fieldNumber: 5)
    }
    if self.isBusy != false {
      try visitor.visitSingularBoolField(value: self.isBusy, fieldNumber: 6)
    }
    switch self.event {
    case .click?: try {
...
extension Api_Core_EventTrackingListRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularEnumField(value: &self._alarmLevel) }()
      default: break
      }
    }
  }
...
extension Api_Core_EventTrackingListResponse.EventTrackingItem: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularEnumField(value: &self.alarmLevel) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.alarmLevel != .levelNone {
      try visitor.visitSingularEnumField(value: self.alarmLevel, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Api_Core_EventTrackingDailyStatsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 8: try { try decoder.decodeSingularEnumField(value: &self._sortBy) }()
      case 9: try { try decoder.decodeSingularBoolField(value: &self.isAsc) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.isAsc != false {
      try visitor.visitSingularBoolField(value: self.isAsc, fieldNumber: 9)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Api_Core_EventTrackingDailyStatsRequest, rhs: Api_Core_EventTrackingDailyStatsRequest) -> Bool {
    ...
    if lhs.isAsc != rhs.isAsc {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Api_Core_EventTrackingDailyStatsRequest.SortBy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "NONE"),
    1: .same(proto: "LAST_ALARM_TRIGGER_TIME"),
    2: .same(proto: "TOTAL_DURATION"),
    3: .same(proto: "ALARM_DURATION"),
    4: .same(proto: "AVG_RESP_TIME"),
    5: .same(proto: "CLICK"),
    6: .same(proto: "SCROLL"),
    7: .same(proto: "SEND"),
    8: .same(proto: "TRIGGER_TIME"),
  ]
}
...
extension Api_Core_SetMonitorAllRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SetMonitorAllRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "is_monitor"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.isMonitor) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.isMonitor != false {
      try visitor.visitSingularBoolField(value: self.isMonitor, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Api_Core_SetMonitorAllRequest, rhs: Api_Core_SetMonitorAllRequest) -> Bool {
    if lhs.isMonitor != rhs.isMonitor {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Api_Core_SetMonitorRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SetMonitorRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "worker_id"),
    2: .standard(proto: "is_monitor"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.workerID) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.isMonitor) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.isMonitor != false {
      try visitor.visitSingularBoolField(value: self.isMonitor, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Api_Core_SetMonitorRequest, rhs: Api_Core_SetMonitorRequest) -> Bool {
    if lhs.workerID != rhs.workerID {return false}
    if lhs.isMonitor != rhs.isMonitor {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Api_Core_WorkerAlarmsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerAlarmsRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "worker_id"),
    2: .same(proto: "page"),
  ...
  public static func ==(lhs: Api_Core_WorkerAlarmsRequest, rhs: Api_Core_WorkerAlarmsRequest) -> Bool {
    if lhs.workerID != rhs.workerID {return false}
    if lhs.page != rhs.page {return false}
    if lhs.pageSize != rhs.pageSize {return false}
    if lhs._timeRange != rhs._timeRange {return false}
...
extension Api_Core_WorkerAlarmsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WorkerAlarmsResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "list"),
    2: .same(proto: "total"),
  ]
  ...
  public static func ==(lhs: Api_Core_WorkerAlarmsResponse, rhs: Api_Core_WorkerAlarmsResponse) -> Bool {
    if lhs.list != rhs.list {return false}
    if lhs.total != rhs.total {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Api_Core_WorkerAlarmsResponse.Item: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Api_Core_WorkerAlarmsResponse.protoMessageName + ".Item"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "alarm_trigger_time"),
    2: .standard(proto: "clearance_time"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.alarmTriggerTime) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.clearanceTime) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.alarmTriggerTime.isEmpty {
      try visitor.visitSingularStringField(value: self.alarmTriggerTime, fieldNumber: 1)
    }
    if !self.clearanceTime.isEmpty {
      try visitor.visitSingularStringField(value: self.clearanceTime, fieldNumber: 2)
    }
    if self.duration != 0 {
  ...
  public static func ==(lhs: Api_Core_WorkerAlarmsResponse.Item, rhs: Api_Core_WorkerAlarmsResponse.Item) -> Bool {
    if lhs.alarmTriggerTime != rhs.alarmTriggerTime {return false}
